...
const Home = () => (
  <>
    ...
    <ProductList games={soon} title="Action" background="black" />
    <ProductList games={promotion} title="Adventure" background="gray" />
    <ProductList games={soon} title="Creation" background="black" />
  </>
)
