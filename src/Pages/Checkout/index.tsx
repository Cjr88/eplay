...
const Checkout = () => {
  ...
  const form = useFormik({
    ...
    onSubmit: (values) => {
      console.log('Form submetido', values)
      purchase({
        billing: {
          document: values.cpf,
          email: values.email,
        ...
        <Card title="Muito obrigado">
          <>
            ...
            <p className="marginTop">
              ...
              que a confirmação pode levar ate 3 dias úteis. Após a aprovação do
              pagamento, enviaremos um e-mail com o código de ativação do jogo.
            </p>
            <p className="marginTop">
              Se você optou pelo pagamento com cartão de crédito, a liberação do
              codigo de ativação ocorrerá após a aprovação da transção pela
              operadora do cartão.{' '}
            </p>
            <p className="marginTop">
